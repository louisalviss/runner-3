...
function execute(key,page){
 ...
 var body='keyboard='+gbkFormEncode(key)+'&show='+encodeURIComponent('title,fantitle')+'&classid=0';
 var r=fetch('http://jpxs123.com/e/search/indexsearch.php',{method:'POST',headers:{'Content-Type':'application/x-www-form-urlencoded','Referer':HOST+'/','User-Agent':'Mozilla/5.0'},body:body});

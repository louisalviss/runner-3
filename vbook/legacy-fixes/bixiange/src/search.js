load('gbk.js');
var HOST='http://www.bixiange.top';
function execute(key,page){
 ...
 var r=fetch('http://www.bixiange.top/e/search/indexpage.php',{method:'POST',headers:{'Content-Type':'application/x-www-form-urlencoded','Referer':HOST+'/','User-Agent':'Mozilla/5.0'},body:body});

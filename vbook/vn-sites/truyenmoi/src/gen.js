...
function execute(url,page){page=page||'1';if(String(page)!=='1')return Response.success([],null);var d=getDoc(url);if(!d)return Response.error('LOAD_FAIL');var a=parseList(d);return a.length?Response.success(a,null):Response.error('NO_ITEM');}

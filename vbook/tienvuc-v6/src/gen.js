load('config.js');
function execute(collection, page) {
    collection = collection || "new-books";
    page = page || "1";
    let response = fetch(BASE_URL + "/api/public-collections/" + encodeURIComponent(collection), {
        method: "GET",
        queries: { page: page, limit: "20" }
    });

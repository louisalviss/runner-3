...
export default {
  async fetch(request, env, ctx) {
    ...
    if (url.pathname === "/delivery-links" || url.pathname === "/delivery-permalinks" || url.pathname === "/delivery-permalinks/revoke" || url.pathname.startsWith("/delivery/") || url.pathname.startsWith("/delivery-permanent/")) {

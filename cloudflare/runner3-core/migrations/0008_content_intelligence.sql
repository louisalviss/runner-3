-- Global Content Intelligence: RSS + social + web scoring/preference database.
-- Raw bodies/captures stay in R2; D1 keeps normalized metadata, features, events and scores.

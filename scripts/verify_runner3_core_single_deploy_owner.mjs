...
if (!/artifact-library-reader-v34-continuous-range-sync-entry\.js/.test(owner)) throw new Error('canonical Reader v34 composition missing');
if (!/v33\+v34:ahead-prefetch\+range-follow\+manual-sync/.test(owner)) throw new Error('canonical Reader v34 proof gate missing');
...
console.log(`RUNNER3_CORE_SINGLE_DEPLOY_OWNER=PASS owner=${allowed} workflows=${files.length} detection=step-aware preview-aware canonical=v34`);

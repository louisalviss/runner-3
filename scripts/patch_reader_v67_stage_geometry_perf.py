...
helper=r'''  async function r3WaitPreRenderStageV67(){
    ...
    const state=window.__r3StageGeometryV67={owner:'stage-geometry-v67',preRender:latest||null,waitMs:Math.round(performance.now()-started),postResizeDisplay:false,postRenderGeometryWait:false,dvhOwner:false,ready:false};
    return latest;
  }
...
v2=one(v2,
    ...
    'V67_DISABLE_POST_RENDER_REDISPLAY_AND_WAIT')

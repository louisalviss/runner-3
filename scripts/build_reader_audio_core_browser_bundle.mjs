...
execFileSync('node', ['--check', 'cloudflare/runner3-core/reader-v65-3-edit-name-ux-runtime.js'], { stdio: 'inherit' });
execFileSync('python3', ['-m', 'py_compile', 'scripts/patch_reader_v65_3_edit_name_ux.py'], { stdio: 'inherit' });
execFileSync('python3', ['scripts/patch_reader_v65_3_edit_name_ux.py'], { stdio: 'inherit' });
execFileSync('python3', ['scripts/check_reader_v65_3_edit_name_ux.py'], { stdio: 'inherit' });

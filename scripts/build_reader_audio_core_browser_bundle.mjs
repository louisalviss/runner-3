...
execFileSync('python3', ['-m', 'py_compile', 'scripts/patch_reader_v65_sync_manage.py'], { stdio: 'inherit' });
execFileSync('python3', ['scripts/patch_reader_v65_sync_manage.py'], { stdio: 'inherit' });
execFileSync('python3', ['scripts/check_reader_v65_sync_manage.py'], { stdio: 'inherit' });
execFileSync('python3', ['-m', 'py_compile', 'scripts/patch_reader_v65_fast_library_index.py'], { stdio: 'inherit' });
execFileSync('python3', ['scripts/patch_reader_v65_fast_library_index.py'], { stdio: 'inherit' });
execFileSync('python3', ['scripts/check_reader_v65_fast_library_index.py'], { stdio: 'inherit' });
execFileSync('node', ['scripts/reader_v65_fast_library_index_smoke.mjs'], { stdio: 'inherit' });
execFileSync('python3', ['-m', 'py_compile', 'scripts/patch_reader_v65_home_screen_startup.py'], { stdio: 'inherit' });
execFileSync('python3', ['scripts/patch_reader_v65_home_screen_startup.py'], { stdio: 'inherit' });
execFileSync('python3', ['scripts/check_reader_v65_home_screen_startup.py'], { stdio: 'inherit' });
execFileSync('python3', ['-m', 'py_compile', 'scripts/patch_reader_v66_standalone_inner_top.py'], { stdio: 'inherit' });
execFileSync('python3', ['scripts/patch_reader_v66_standalone_inner_top.py'], { stdio: 'inherit' });
execFileSync('python3', ['scripts/check_reader_v66_standalone_inner_top.py'], { stdio: 'inherit' });
execFileSync('python3', ['-m', 'py_compile', 'scripts/patch_reader_v68_full_bleed_autostretch.py'], { stdio: 'inherit' });
execFileSync('python3', ['scripts/patch_reader_v68_full_bleed_autostretch.py'], { stdio: 'inherit' });
execFileSync('python3', ['scripts/check_reader_v68_full_bleed_autostretch.py'], { stdio: 'inherit' });
execFileSync('python3', ['-m', 'py_compile', 'scripts/patch_reader_v68_library_full_bleed_owner.py'], { stdio: 'inherit' });
execFileSync('python3', ['scripts/patch_reader_v68_library_full_bleed_owner.py'], { stdio: 'inherit' });
execFileSync('python3', ['scripts/check_reader_v68_library_full_bleed_owner.py'], { stdio: 'inherit' });
...
execFileSync('python3', ['-m', 'py_compile', 'scripts/patch_reader_v72_unified_state.py'], { stdio: 'inherit' });
execFileSync('python3', ['scripts/patch_reader_v72_unified_state.py'], { stdio: 'inherit' });
execFileSync('python3', ['scripts/check_reader_v72_unified_state.py'], { stdio: 'inherit' });
execFileSync('node', ['scripts/reader_v72_unified_state_smoke.mjs'], { stdio: 'inherit' });
execFileSync('python3', ['-m', 'py_compile', 'scripts/patch_reader_v73_single_owner_session.py'], { stdio: 'inherit' });
execFileSync('python3', ['scripts/patch_reader_v73_single_owner_session.py'], { stdio: 'inherit' });
execFileSync('python3', ['scripts/check_reader_v73_single_owner_session.py'], { stdio: 'inherit' });
execFileSync('python3', ['-m', 'py_compile', 'scripts/patch_reader_v74_session_bound_sync.py'], { stdio: 'inherit' });
execFileSync('python3', ['scripts/patch_reader_v74_session_bound_sync.py'], { stdio: 'inherit' });
execFileSync('python3', ['scripts/check_reader_v74_session_bound_sync.py'], { stdio: 'inherit' });
execFileSync('python3', ['-m', 'py_compile', 'scripts/patch_reader_v75_ingress_owner_session.py'], { stdio: 'inherit' });
execFileSync('python3', ['scripts/patch_reader_v75_ingress_owner_session.py'], { stdio: 'inherit' });
execFileSync('python3', ['scripts/check_reader_v75_ingress_owner_session.py'], { stdio: 'inherit' });

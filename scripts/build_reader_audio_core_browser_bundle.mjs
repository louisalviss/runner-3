...
execFileSync('python3', ['-m', 'py_compile', 'scripts/patch_reader_v76_auth_passthrough.py'], { stdio: 'inherit' });
...
execFileSync('python3', ['-m', 'py_compile', 'scripts/patch_reader_v92_single_interaction_owner.py'], { stdio: 'inherit' });
...
execFileSync('node', ['scripts/reader_v94_frame_rebind_smoke.mjs'], { stdio: 'inherit' });
execFileSync('python3', ['scripts/check_reader_v98_nonblocking_restore_source.py'], { stdio: 'inherit' });
execFileSync('python3', ['scripts/check_reader_v100_event_driven_responsiveness.py'], { stdio: 'inherit' });
...
execFileSync('python3', ['scripts/check_reader_v82_stable_shell.py'], { stdio: 'inherit' });
...
execFileSync('node', ['scripts/reader_v110_clean_ios_smoke.mjs'], { stdio: 'inherit' });

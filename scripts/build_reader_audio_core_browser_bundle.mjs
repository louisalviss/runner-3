...
execFileSync('python3', ['-m', 'py_compile', 'scripts/patch_reader_v65_1_manage_sheet.py'], { stdio: 'inherit' });
execFileSync('python3', ['scripts/patch_reader_v65_1_manage_sheet.py'], { stdio: 'inherit' });
execFileSync('python3', ['scripts/check_reader_v65_1_manage_sheet.py'], { stdio: 'inherit' });
execFileSync('python3', ['-m', 'py_compile', 'scripts/patch_reader_v65_2_manage_sheet_quote_fix.py'], { stdio: 'inherit' });
execFileSync('python3', ['scripts/patch_reader_v65_2_manage_sheet_quote_fix.py'], { stdio: 'inherit' });

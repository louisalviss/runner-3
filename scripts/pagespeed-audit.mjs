...
const result = { target, checkedAt: new Date().toISOString(), source: 'Google PageSpeed Insights API v5', runs: {} };
...
for (const strategy of strategies) {
  ...
  result.runs[strategy] = {
    ...
    failedAudits: Object.values(audits).filter(a=>a && a.score !== null && a.score < 1 && ['binary','numeric'].includes(a.scoreDisplayMode)).slice(0,80).map(a=>({id:a.id,title:a.title,score:a.score,displayValue:a.displayValue||null,numericValue:a.numericValue??null}))
  };
}

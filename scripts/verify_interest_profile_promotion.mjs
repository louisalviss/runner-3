...
const rssLibrarySavePath = path.join(repoRoot, "cloudflare/runner3-core/src/rss-library-save.js");
const rssLibrarySave = fs.readFileSync(rssLibrarySavePath, "utf8");
...
function requireRssText(needle, message) { if (!rssLibrarySave.includes(needle)) throw new Error(message); }
